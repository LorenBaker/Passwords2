...
public class DownloadTextFile extends AsyncTask<Void, Long, Boolean> {
    ...
    public interface DownloadFinishedListener {
        void fileDownloadFinished(Boolean result);
    }
    ...
    private String readFile() {
        try {
            ...
            MyLog.i("DownloadTextFile", "readFile: File exists; " + existingEntry.bytes + " bytes; rev is now: " + existingEntry.rev);
            if (existingEntry.bytes == 0) {
                MyLog.e("DownloadTextFile", "readFile: File" + existingEntry.fileName() + " exists but is empty!");
                return "";
            }
            ...
            MyLog.e("DownloadTextFile", "readFile: DropboxUnlinkedException - The AuthSession wasn't properly authenticated or user unlinked.");
        } catch (DropboxPartialFileException e) {
            // We canceled the operation
            mErrorMsg = "Download canceled";
            MyLog.i("DownloadTextFile", "readFile: " + mErrorMsg);
        } catch (DropboxServerException e) {
            // Server-side exception.  These are examples of what could happen,
            // but we don't do anything special with them here.
            if (e.error == DropboxServerException._304_NOT_MODIFIED) {
                // won't happen since we don't pass in revision with metadata
                MyLog.e("DownloadTextFile", "readFile: " + "_304_NOT_MODIFIED");

            } else if (e.error == DropboxServerException._401_UNAUTHORIZED) {
                // Unauthorized, so we should unlink them.  You may want to
                // automatically log the user out in this case.
                MyLog.e("DownloadTextFile", "readFile: " + "_401_UNAUTHORIZED");

            } else if (e.error == DropboxServerException._403_FORBIDDEN) {
                // Not allowed to access this
                MyLog.e("DownloadTextFile", "readFile: " + "_403_FORBIDDEN");

            } else if (e.error == DropboxServerException._404_NOT_FOUND) {
                // path not found (or if it was the thumbnail, can't be a thumbnail)
                MyLog.e("DownloadTextFile", "readFile: " + "_404_NOT_FOUND");

            } else if (e.error == DropboxServerException._406_NOT_ACCEPTABLE) {
                // too many entries to return
                MyLog.e("DownloadTextFile", "readFile: " + "_406_NOT_ACCEPTABLE");

            } else if (e.error == DropboxServerException._415_UNSUPPORTED_MEDIA) {
                MyLog.e("DownloadTextFile", "readFile: " + "_415_UNSUPPORTED_MEDIA");

            } else if (e.error == DropboxServerException._507_INSUFFICIENT_STORAGE) {
                // user is over quota
                MyLog.e("DownloadTextFile", "readFile: " + "_507_INSUFFICIENT_STORAGE");

            } else {
                // Something else
                MyLog.e("DownloadTextFile", "readFile: " + "Unknown DropboxServerException");
            ...
            MyLog.i("DownloadTextFile", "readFile: IOException: " + e.getMessage());
            e.printStackTrace();
        }
        return "";
    }
    ...
    private String decryptFile(String encryptedContents) {
        MyLog.i("DownloadTextFile", "decryptFile: START");
        ...
        try {
            ...
            MyLog.i("DownloadTextFile", "decryptFile: Decrypted file length = " + decryptedContents.length() + " bytes.");

        } catch (InvalidKeyException e) {
            MyLog.e("DownloadTextFile", "decryptFile: InvalidKeyException");
            e.printStackTrace();
        } catch (NoSuchPaddingException e) {
            MyLog.e("DownloadTextFile", "decryptFile: NoSuchPaddingException");
            e.printStackTrace();
        } catch (BadPaddingException e) {
            MyLog.e("DownloadTextFile", "decryptFile: BadPaddingException");
            e.printStackTrace();
        } catch (NoSuchAlgorithmException e) {
            MyLog.e("DownloadTextFile", "decryptFile: NoSuchAlgorithmException");
            e.printStackTrace();
        } catch (IllegalBlockSizeException e) {
            MyLog.e("DownloadTextFile", "decryptFile: IllegalBlockSizeException");
            e.printStackTrace();
        } catch (UnsupportedEncodingException e) {
            MyLog.e("DownloadTextFile", "decryptFile: UnsupportedEncodingException");
            e.printStackTrace();
        } catch (InvalidAlgorithmParameterException e) {
            MyLog.e("DownloadTextFile", "decryptFile: InvalidAlgorithmParameterException");
            e.printStackTrace();
        }
    ...
    private clsLabPasswords parseJsonFile(String decryptedFileContent) {
        MyLog.i("DownloadTextFile", "parseJsonFile: START");
        ...
        try {
            ...
            if (passwordsData != null) {
                ...
                MyLog.d("DownloadTextFile", "parseJsonFile: found " + numberOfUsers + " Users; " + numberOfItems + " Items.");
            }
        } catch (JsonSyntaxException e) {
            MyLog.e("DownloadTextFile", "parseJsonFile: JsonSyntaxException: " + e.getMessage());
            e.printStackTrace();
        }
    ...
    private void updateSQLiteDatabase(clsLabPasswords passwordsData) {
        MyLog.i("DownloadTextFile", "updateSQLiteDatabase: START");
        ...
        MyLog.i("DownloadTextFile", "updateSQLiteDatabase: deleted " + usersDeleted + " records from the database.");
        int itemsDeleted = ItemsTable.deleteItemsNotInTable(mContext);
        MyLog.i("DownloadTextFile", "updateSQLiteDatabase: deleted " + itemsDeleted + " items from the items table.");
    ...
    protected void onPostExecute(Boolean result) {
        MyLog.d("DownloadTextFile", "onPostExecute: result = " + result);
        mCallback.fileDownloadFinished(result);
