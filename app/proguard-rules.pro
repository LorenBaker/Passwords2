...
-keep class com.lbconsulting.password2.classes.clsLabPasswords { *; }
-keep class com.lbconsulting.password2.classes.clsItem { *; }
-keep class com.lbconsulting.password2.classes.clsUsers { *; }
